...
function dragDrop() {
    ...
    const categoryType = this.id;
    if (categoryType === 'vowels') {
        draggedItem.classList.remove('consonant');
        draggedItem.classList.add('vowel');
    } else if (categoryType === 'consonants') {
        draggedItem.classList.remove('vowel');
        draggedItem.classList.add('consonant');
    }
}
